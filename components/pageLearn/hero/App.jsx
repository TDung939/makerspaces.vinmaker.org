    ...
    <Box bg="gray.800" as="section" minH="140px" position="relative">
      ...
      >
        <Box position="relative" w="full" h="full">
          <Img
            src="https://res.cloudinary.com/dpec7wjtk/image/upload/v1622819524/VinMakerSpace%20Network/pexels-polina-zimmerman-3778615_1_ipjmo6.png"
            alt="Main Image"
            w="full"
            h="full"
            objectFit="cover"
